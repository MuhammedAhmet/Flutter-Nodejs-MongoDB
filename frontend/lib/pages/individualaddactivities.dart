...
class IndAddActivities extends StatefulWidget {
  const IndAddActivities({Key? key}) : super(key: key);

  @override
  _IndAddActivitiesState createState() => _IndAddActivitiesState();
}

class _IndAddActivitiesState extends State<IndAddActivities> {
  String date = "";
  String hour = "";
  String response = "";
          ...
          appBar: new AppBar(
            ...
            actions: <Widget>[
              new IconButton(icon: const Icon(Icons.save), onPressed: () {
                ...
                {
                  ValidatorAndSave();
                  successfullIndivAddedActivity(context);
                }
                else
                {
                  errorAddedActivity(context);
